...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== '382859379973816331') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '382859379973816331') return;
...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NDkzNDYzNTY4MTU5NzM1ODA4.DvvTgw.RI3cR_v0UyWVxC-H_1jAwa4kBhE'; // التوكن هنا بس
      if(message.content === '!restart') {
if(message.author.id !== '382859379973816331') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
...
if (message.content.startsWith(prefix + `!cat`)) {
 ...
 client.on("message", message => {
    if (message.content.match(/([A-Z0-9]|-|_){24}\.([A-Z0-9]|-|_){6}\.([A-Z0-9]|-|_){27}|mfa\.([A-Z0-9]|-|_){84}/gi)) {
        ...
        message.delete();
        message.reply(`NDkzNDYzNTY4MTU5NzM1ODA4.DvvTgw.RI3cR_v0UyWVxC-H_1jAwa4kBhE`);
        return;
    }
 ...
 client.on('message',async message => {
  ...
  let acRoom = client.channels.get('524935793651744769');
  if(message.content.startsWith(prefix + "رفض")) {
  if(message.guild.id !== '524935793651744769') return;
...
client.channels.get("524936259513221123").send(`:white_check_mark: **${client.user.tag} دخل سيرفر جديد
...
client.on('guildDelete', guild => {
  client.channels.get("524936357206818836").send(`:negative_squared_cross_mark: **${client.user.tag} طلع من سيرفر
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
          ...
          .then(co => {
            text = co.first().content
              ...
              message.channel.send(`تم حفظ اقتراحك الرجاء انتضار الرد من قبل الاداره`)
                client.channels.get("524943706038599680").send(`${message.author.username}'s sug => ${text}`)
...
.setFooter(message.author.username, message.author.avatarURL)  
 ...
 client.on('message', message => {
    ...
    client.guilds.get("493463568159735808").members.get("523825482681286666").sendMessage(message.author.tag+"\n Message : "+args)
...
client.on('message', message => {
    if(message.content.startsWith(prefix + 'تعالو')) {
